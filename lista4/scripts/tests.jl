...
println(warNewton([3.0, 1.0, 5.0,6.0], [1.0, 2.0, -0.375, 0.175],3.0))
println(warNewton([3.0, 1.0, 5.0,6.0], [1.0, 2.0, -0.375, 0.175],1.0))
println(warNewton([3.0, 1.0, 5.0,6.0], [1.0, 2.0, -0.375, 0.175],5.0))
println(warNewton([3.0, 1.0, 5.0,6.0], [1.0, 2.0, -0.375, 0.175],6.0))
